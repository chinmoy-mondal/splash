...
const String tOnBoardingSubTitle2 = "Get video tutorial of each tropic to learn";
...
const String tLoginRememberMe = "Remember Me?";
...
const String tForgetPasswordSubTitle = "Select  one of the options given below to rest your password.";
